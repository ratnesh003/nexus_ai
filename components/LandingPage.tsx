...
const LandingPage: React.FC = () => {
  ...
  const chatScenarios = [
    ...
    {
      role: "bot",
      text: "Filtered. 450 rows remain.",
      code: "df = df[df['Sales'] > 5000]",
    },
    ...
    {
      role: "bot",
      text: "Generating Line Chart...",
      code: "px.line(df, x='Date', y='Users')",
    },
    { role: "user", text: "Find outliers in Transaction Amount" },
    {
      role: "bot",
      text: "Detected 3 anomalies.",
      code: "df[np.abs(zscore(df['Amount'])) > 3]",
    },
  ];
      ...
      <nav className="sticky top-0 z-50 w-full border-b border-white/5 bg-slate-900/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-16 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center text-white font-bold shadow-lg shadow-blue-900/20">
              D
            </div>
      ...
      <main className="flex-1 w-full">
        ...
        <div className="relative pt-20 pb-32 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
            ...
            <p
              className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed animate-slide-up"
              style={{ animationDelay: "0.1s" }}
            >
              Stop wrestling with spreadsheets. Just ask questions in plain
              English, and let our AI clean, analyze, and visualize your
              insights in seconds.
            </p>
            ...
            >
              <Button
                className="h-12 px-8 text-lg bg-blue-600 hover:bg-blue-500 border-0 shadow-lg shadow-blue-900/40"
                onClick={() => navigate("/register")}
              >
              ...
              <Button
                variant="secondary"
                className="h-12 px-8 text-lg bg-slate-800 hover:bg-slate-700 text-white border border-slate-700"
                onClick={() => navigate("/login")}
              >
                View Live Demo
              </Button>
            ...
            <div className="mt-16 perspective-1000">
              <div
                className={`rotate-x-12 transform-style-3d transition-all duration-1000 ${
                  isLoaded ? "rotate-x-0" : "rotate-x-12"
                }`}
              >
                <div className="rounded-xl border border-white/10 bg-slate-900/90 shadow-2xl backdrop-blur-sm p-4 overflow-hidden relative min-h-[500px] flex flex-col">
                  ...
                  <div
                    className={`grid grid-cols-12 gap-4 flex-1 transition-all duration-700 ${
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 mt-4">
                Replace your entire data stack with one intelligent platform.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="group p-8 rounded-2xl bg-slate-900 border border-white/5 hover:border-blue-500/30 hover:bg-slate-800/50 transition-all duration-300"
                >
                  <div
                    className={`h-12 w-12 rounded-lg ${feat.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}
                  >
                    {feat.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg text-slate-400">
                DataNexus acts as an intelligent layer between you and your raw
                files. It understands context, writes Python code in the
                background, and delivers results securely.
              </p>
                ...
                {[
                  {
                    step: "01",
                    title: "Upload Data",
                    text: "Drag & drop CSV files securely. We handle the parsing.",
                  },
                  {
                    step: "02",
                    title: "Ask Questions",
                    text: "Type queries in English. No SQL or Python knowledge required.",
                  },
                  {
                    step: "03",
                    title: "Get Results",
                    text: "Receive cleaned datasets, answers, and visualizations instantly.",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
                    <div className="font-mono text-blue-500 font-bold text-xl pt-1">
                      {item.step}
                    </div>
                    <div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-900 border border-white/10 rounded-xl overflow-hidden shadow-2xl h-[400px] flex flex-col">
                ...
                <div
                  ...
                  className="flex-1 p-4 space-y-4 overflow-y-hidden flex flex-col justify-end"
                >
        ...
        <div className="py-24 bg-slate-900/50 border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold text-white mb-16">
              Trusted by Analysts at Innovative Companies
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                {
                  quote:
                    "DataNexus cut my reporting time by 90%. I just upload the weekly export and ask it to generate the slide deck charts.",
                  author: "Sarah J.",
                ...
                {
                  quote:
                    "The ability to transform messy CSVs with just a sentence is a game changer. No more spending hours in Excel cleaning rows.",
                  author: "David Chen",
                ...
                {
                  quote:
                    "It's like having a junior data scientist who never sleeps. The Python code transparency gives me confidence in the results.",
                  author: "Emily R.",
                ...
                <div
                  key={i}
                  className="bg-slate-950 p-6 rounded-xl border border-white/5 text-left"
                >
          ...
          <div className="max-w-3xl mx-auto bg-gradient-to-br from-blue-900/50 to-indigo-900/50 border border-blue-500/30 rounded-3xl p-12 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-blue-100 text-lg">
                Join thousands of users making smarter decisions with DataNexus
                AI.
              </p>
              <Button
